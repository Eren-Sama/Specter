...
-> GitHub contents API: read src/main.py (attempt 1/2)
[ok] Read src/main.py
-> GitHub contents API: read src/orchestrator.py (attempt 1/2)
[ok] Read src/orchestrator.py
-> GitHub contents API: read src/__main__.py (attempt 1/2)
[ok] Read src/__main__.py
-> GitHub contents API: read src/crawlers/http_client.py (attempt 1/2)
[ok] Read src/crawlers/http_client.py
-> GitHub contents API: read src/crawlers/f6s_crawler.py (attempt 1/2)
[ok] Read src/crawlers/f6s_crawler.py
-> GitHub contents API: read src/crawlers/wellfound_crawler.py (attempt 1/2)
[ok] Read src/crawlers/wellfound_crawler.py
-> GitHub contents API: read src/crawlers/saashub_crawler.py (attempt 1/2)
[ok] Read src/crawlers/saashub_crawler.py
-> GitHub contents API: read src/crawlers/yc_crawler.py (attempt 1/2)
[ok] Read src/crawlers/yc_crawler.py
-> Python static analyzer: inspect selected source files (attempt 1/2)
[ok] Static analysis completed
[ok] Validated 27 findings
...
[ok] Wrote Markdown report to reports\startupscout_report.md
[ok] Wrote JSON report to reports\startupscout_report.json
